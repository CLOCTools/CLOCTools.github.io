...
CLOCTools makes use of a variety of progamming languages. This section lists tools to interface across these languages.
...
- [cpp-matlab-demos](https://github.com/stanley-rozell/hmm/tree/master/matlab) - using mex to verify algos in c++ *(currently a part of the HMM repository)*
